...
// Create function
 ...
 // Running the following code should create and move balls on the screen
 // This is expected to create 5 balls within the area div
  initialize();
  const ball1 = create('white', 4, 3);
  const ball2 = create('#white', 1, 5);
  const ball3 = create('#white', 2, 2);
  const ball4 = create('#white', 1, 2);
  const ball5 = create('#white', 2, 5);
  moveTo(ball1, 1, 1);
  moveTo(ball2, 10, 10);
  moveTo(ball3, 20, 20);
  moveTo(ball4, 30, 30);
